...
xlabel(X_Label,'FontName',fn)
ylabel(Y_Label,'FontName',fn)


legend(labelinput_new, 'Location','EastOutside','NumColumns',2)
...
axis([H1,H2,V1,V2])
set(gca,'XTick',NN,'XTickLabel',str,'FontName',fn)
grid on
